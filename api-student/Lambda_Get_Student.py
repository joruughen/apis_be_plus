...
def lambda_handler(event, context):
    ...
    try:
        ...
        logger.info("DynamoDB response for student: %s", db_response)

        # Verificar si el estudiante existe en la tabla
        ...
        logger.error(f"Error al obtener el estudiante desde DynamoDB: {e}")
        return {
            'statusCode': 500,
            'body': 'Error interno del servidor al obtener datos del estudiante'
        }
